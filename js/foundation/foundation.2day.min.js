...
!function(t,e,a){"use strict";Foundation.libs.abide={name:"abide",version:"{{VERSION}}",settings:{live_validate:!0,focus_on_invalid:!0,error_labels:!0,timeout:1e3,patterns:{alpha:/^[a-zA-Z]+$/,alpha_numeric:/^[a-zA-Z0-9]+$/,integer:/^[-+]?\d+$/,number:/^[-+]?\d*(?:[\.\,]\d+)?$/,card:/^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/,cvv:/^([0-9]){3,4}$/,email:/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+$/,url:/^(https?|ftp|file|ssh):\/\/(((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-zA-Z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-zA-Z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/,domain:/^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$/,datetime:/^([0-2][0-9]{3})\-([0-1][0-9])\-([0-3][0-9])T([0-5][0-9])\:([0-5][0-9])\:([0-5][0-9])(Z|([\-\+]([0-1][0-9])\:00))$/,date:/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))$/,time:/^(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}$/,dateISO:/^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}$/,month_day_year:/^(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.]\d{4}$/,day_month_year:/^(0[1-9]|[12][0-9]|3[01])[- \/.](0[1-9]|1[012])[- \/.]\d{4}$/,color:/^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/},validators:{equalTo:function(t){var e=a.getElementById(t.getAttribute(this.add_namespace("data-equalto"))).value,i=t.value,r=e===i;return r}}},timer:null,init:function(t,e,a){this.bindings(e,a)},events:function(e){var a=this,i=a.S(e).attr("novalidate","novalidate"),r=i.data(this.attr_name(!0)+"-init")||{};this.invalid_attr=this.add_namespace("data-invalid"),i.off(".abide").on("submit.fndtn.abide validate.fndtn.abide",function(t){var e=/ajax/i.test(a.S(this).attr(a.attr_name()));return a.validate(a.S(this).find("input, textarea, select").get(),t,e)}).on("reset",function(){return a.reset(t(this))}).find("input, textarea, select").off(".abide").on("blur.fndtn.abide change.fndtn.abide",function(t){a.validate([this],t)}).on("keydown.fndtn.abide",function(t){r.live_validate===!0&&(clearTimeout(a.timer),a.timer=setTimeout(function(){a.validate([this],t)}.bind(this),r.timeout))})},reset:function(e){e.removeAttr(this.invalid_attr),t(this.invalid_attr,e).removeAttr(this.invalid_attr),t(".error",e).not("small").removeClass("error")},validate:function(t,e,a){for(var i=this.parse_patterns(t),r=i.length,n=this.S(t[0]).closest("form"),s=/submit/.test(e.type),d=0;r>d;d++)if(!i[d]&&(s||a))return this.settings.focus_on_invalid&&t[d].focus(),n.trigger("invalid"),this.S(t[d]).closest("form").attr(this.invalid_attr,""),!1;return(s||a)&&n.trigger("valid"),n.removeAttr(this.invalid_attr),a?!1:!0},parse_patterns:function(t){for(var e=t.length,a=[];e--;)a.push(this.pattern(t[e]));return this.check_validation_and_apply_styles(a)},pattern:function(t){var e=t.getAttribute("type"),a="string"==typeof t.getAttribute("required"),i=t.getAttribute("pattern")||"";return this.settings.patterns.hasOwnProperty(i)&&i.length>0?[t,this.settings.patterns[i],a]:i.length>0?[t,new RegExp(i),a]:this.settings.patterns.hasOwnProperty(e)?[t,this.settings.patterns[e],a]:(i=/.*/,[t,i,a])},check_validation_and_apply_styles:function(e){var a=e.length,i=[],r=this.S(e[0][0]).closest("[data-"+this.attr_name(!0)+"]");for(r.data(this.attr_name(!0)+"-init")||{};a--;){var n,s,d=e[a][0],u=e[a][2],l=d.value.trim(),F=this.S(d).parent(),o=d.getAttribute(this.add_namespace("data-abide-validator")),h="radio"===d.type,v="checkbox"===d.type,_=this.S('label[for="'+d.getAttribute("id")+'"]'),f=u?d.value.length>0:!0,c=[];if(d.getAttribute(this.add_namespace("data-equalto"))&&(o="equalTo"),n=F.is("label")?F.parent():F,o&&(s=this.settings.validators[o].apply(this,[d,u,n]),c.push(s)),h&&u)c.push(this.valid_radio(d,u));else if(v&&u)c.push(this.valid_checkbox(d,u));else{if(e[a][1].test(l)&&f||!u&&d.value.length<1||t(d).attr("disabled")?c.push(!0):c.push(!1),c=[c.every(function(t){return t})],c[0])this.S(d).removeAttr(this.invalid_attr),d.setAttribute("aria-invalid","false"),d.removeAttribute("aria-describedby"),n.removeClass("error"),_.length>0&&this.settings.error_labels&&_.removeClass("error").removeAttr("role"),t(d).triggerHandler("valid");else{this.S(d).attr(this.invalid_attr,""),d.setAttribute("aria-invalid","true");var A=n.find("small.error, span.error"),m=A.length>0?A[0].id:"";m.length>0&&d.setAttribute("aria-describedby",m),n.addClass("error"),_.length>0&&this.settings.error_labels&&_.addClass("error").attr("role","alert"),t(d).triggerHandler("invalid")}i.push(c[0])}}return i=[i.every(function(t){return t})]},valid_checkbox:function(t,e){var t=this.S(t),a=t.is(":checked")||!e;return a?t.removeAttr(this.invalid_attr).parent().removeClass("error"):t.attr(this.invalid_attr,"").parent().addClass("error"),a},valid_radio:function(t){for(var e=t.getAttribute("name"),a=this.S(t).closest("[data-"+this.attr_name(!0)+"]").find("[name='"+e+"']"),i=a.length,r=!1,n=0;i>n;n++)a[n].checked&&(r=!0);for(var n=0;i>n;n++)r?this.S(a[n]).removeAttr(this.invalid_attr).parent().removeClass("error"):this.S(a[n]).attr(this.invalid_attr,"").parent().addClass("error");return r},valid_equal:function(t,e,i){var r=a.getElementById(t.getAttribute(this.add_namespace("data-equalto"))).value,n=t.value,s=r===n;return s?(this.S(t).removeAttr(this.invalid_attr),i.removeClass("error")):(this.S(t).attr(this.invalid_attr,""),i.addClass("error")),s},valid_oneof:function(t,e,a,i){var t=this.S(t),r=this.S("["+this.add_namespace("data-oneof")+"]"),n=r.filter(":checked").length>0;if(n?t.removeAttr(this.invalid_attr).parent().removeClass("error"):t.attr(this.invalid_attr,"").parent().addClass("error"),!i){var s=this;r.each(function(){s.valid_oneof.call(s,this,null,null,!0)})}return n}}}(jQuery,window,window.document);
!function(t){"use strict";Foundation.libs.accordion={name:"accordion",version:"{{VERSION}}",settings:{active_class:"active",multi_expand:!1,toggleable:!0,callback:function(){}},init:function(t,a,e){this.bindings(a,e)},events:function(){var a=this,e=this.S;e(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion","["+this.attr_name()+"] > dd > a",function(n){var i=e(this).closest("["+a.attr_name()+"]"),s=a.attr_name()+"="+i.attr(a.attr_name()),c=i.data(a.attr_name(!0)+"-init"),l=e("#"+this.href.split("#")[1]),d=t("> dd",i),o=d.children(".content"),r=o.filter("."+c.active_class);return n.preventDefault(),i.attr(a.attr_name())&&(o=o.add("["+s+"] dd > .content"),d=d.add("["+s+"] dd")),c.toggleable&&l.is(r)?(l.parent("dd").toggleClass(c.active_class,!1),l.toggleClass(c.active_class,!1),c.callback(l),l.triggerHandler("toggled",[i]),i.triggerHandler("toggled",[l]),void 0):(c.multi_expand||(o.removeClass(c.active_class),d.removeClass(c.active_class)),l.addClass(c.active_class).parent().addClass(c.active_class),c.callback(l),l.triggerHandler("toggled",[i]),i.triggerHandler("toggled",[l]),void 0)})},off:function(){},reflow:function(){}}}(jQuery,window,window.document);
...
!function(t,e){"use strict";Foundation.libs.slider={name:"slider",version:"{{VERSION}}",settings:{start:0,end:100,step:1,initial:null,display_selector:"",vertical:!1,on_change:function(){}},cache:{},init:function(t,e,a){Foundation.inherit(this,"throttle"),this.bindings(e,a),this.reflow()},events:function(){var a=this;t(this.scope).off(".slider").on("mousedown.fndtn.slider touchstart.fndtn.slider pointerdown.fndtn.slider","["+a.attr_name()+"]:not(.disabled, [disabled]) .range-slider-handle",function(e){a.cache.active||(e.preventDefault(),a.set_active_slider(t(e.target)))}).on("mousemove.fndtn.slider touchmove.fndtn.slider pointermove.fndtn.slider",function(n){if(a.cache.active)if(n.preventDefault(),t.data(a.cache.active[0],"settings").vertical){var i=0;n.pageY||(i=e.scrollY),a.calculate_position(a.cache.active,(n.pageY||n.originalEvent.clientY||n.originalEvent.touches[0].clientY||n.currentPoint.y)+i)}else a.calculate_position(a.cache.active,n.pageX||n.originalEvent.clientX||n.originalEvent.touches[0].clientX||n.currentPoint.x)}).on("mouseup.fndtn.slider touchend.fndtn.slider pointerup.fndtn.slider",function(){a.remove_active_slider()}).on("change.fndtn.slider",function(){a.settings.on_change()}),a.S(e).on("resize.fndtn.slider",a.throttle(function(){a.reflow()},300))},set_active_slider:function(t){this.cache.active=t},remove_active_slider:function(){this.cache.active=null},calculate_position:function(e,a){var n=this,i=t.data(e[0],"settings"),r=(t.data(e[0],"handle_l"),t.data(e[0],"handle_o"),t.data(e[0],"bar_l")),s=t.data(e[0],"bar_o");requestAnimationFrame(function(){var t;t=Foundation.rtl&&!i.vertical?n.limit_to((s+r-a)/r,0,1):n.limit_to((a-s)/r,0,1),t=i.vertical?1-t:t;var o=n.normalized_value(t,i.start,i.end,i.step);n.set_ui(e,o)})},set_ui:function(e,a){var n=t.data(e[0],"settings"),i=t.data(e[0],"handle_l"),r=t.data(e[0],"bar_l"),s=this.normalized_percentage(a,n.start,n.end),o=s*(r-i)-1,l=100*s;Foundation.rtl&&!n.vertical&&(o=-o),o=n.vertical?-o+r-i+1:o,this.set_translate(e,o,n.vertical),n.vertical?e.siblings(".range-slider-active-segment").css("height",l+"%"):e.siblings(".range-slider-active-segment").css("width",l+"%"),e.parent().attr(this.attr_name(),a).trigger("change").trigger("change.fndtn.slider"),e.parent().children("input[type=hidden]").val(a),e[0].hasAttribute("aria-valuemin")||e.attr({"aria-valuemin":n.start,"aria-valuemax":n.end}),e.attr("aria-valuenow",a)},normalized_percentage:function(t,e,a){return Math.min(1,(t-e)/(a-e))},normalized_value:function(t,e,a,n){var i=a-e,r=t*i,s=(r-r%n)/n,o=r%n,l=o>=.5*n?n:0;return s*n+l+e},set_translate:function(e,a,n){n?t(e).css("-webkit-transform","translateY("+a+"px)").css("-moz-transform","translateY("+a+"px)").css("-ms-transform","translateY("+a+"px)").css("-o-transform","translateY("+a+"px)").css("transform","translateY("+a+"px)"):t(e).css("-webkit-transform","translateX("+a+"px)").css("-moz-transform","translateX("+a+"px)").css("-ms-transform","translateX("+a+"px)").css("-o-transform","translateX("+a+"px)").css("transform","translateX("+a+"px)")},limit_to:function(t,e,a){return Math.min(Math.max(t,e),a)},initialize_settings:function(e){var a=t.extend({},this.settings,this.data_options(t(e).parent()));a.vertical?(t.data(e,"bar_o",t(e).parent().offset().top),t.data(e,"bar_l",t(e).parent().outerHeight()),t.data(e,"handle_o",t(e).offset().top),t.data(e,"handle_l",t(e).outerHeight())):(t.data(e,"bar_o",t(e).parent().offset().left),t.data(e,"bar_l",t(e).parent().outerWidth()),t.data(e,"handle_o",t(e).offset().left),t.data(e,"handle_l",t(e).outerWidth())),t.data(e,"bar",t(e).parent()),t.data(e,"settings",a)},set_initial_position:function(e){var a=t.data(e.children(".range-slider-handle")[0],"settings"),n=a.initial?a.initial:Math.floor(.5*(a.end-a.start)/a.step)*a.step+a.start,i=e.children(".range-slider-handle");this.set_ui(i,n)},set_value:function(e){var a=this;t("["+a.attr_name()+"]",this.scope).each(function(){t(this).attr(a.attr_name(),e)}),t(this.scope).attr(a.attr_name())&&t(this.scope).attr(a.attr_name(),e),a.reflow()},reflow:function(){var e=this;e.S("["+this.attr_name()+"]").each(function(){var a=t(this).children(".range-slider-handle")[0],n=t(this).attr(e.attr_name());e.initialize_settings(a),n?e.set_ui(t(a),parseFloat(n)):e.set_initial_position(t(this))})}}}(jQuery,window,window.document);
!function(t,a,e,n){"use strict";Foundation.libs.tab={name:"tab",version:"{{VERSION}}",settings:{active_class:"active",callback:function(){},deep_linking:!1,scroll_to_content:!0,is_hover:!1},default_tab_hashes:[],init:function(t,a,e){var n=this,i=this.S;this.bindings(a,e),this.handle_location_hash_change(),i("["+this.attr_name()+"] > .active > a",this.scope).each(function(){n.default_tab_hashes.push(this.hash)})},events:function(){var t=this,n=this.S,i=function(a){var e=n(this).closest("["+t.attr_name()+"]").data(t.attr_name(!0)+"-init");(!e.is_hover||Modernizr.touch)&&(a.preventDefault(),a.stopPropagation(),t.toggle_active_tab(n(this).parent()))};n(this.scope).off(".tab").on("focus.fndtn.tab","["+this.attr_name()+"] > * > a",i).on("click.fndtn.tab","["+this.attr_name()+"] > * > a",i).on("mouseenter.fndtn.tab","["+this.attr_name()+"] > * > a",function(){var a=n(this).closest("["+t.attr_name()+"]").data(t.attr_name(!0)+"-init");a.is_hover&&t.toggle_active_tab(n(this).parent())}),n(a).on("hashchange.fndtn.tab",function(a){a.preventDefault(),t.handle_location_hash_change()}).on("keyup",function(t){9==t.keyword&&console.log(e.querySelector("[data-tab] .tab-title :focus"))})},handle_location_hash_change:function(){var a=this,e=this.S;e("["+this.attr_name()+"]",this.scope).each(function(){var i=e(this).data(a.attr_name(!0)+"-init");if(i.deep_linking){var s;if(s=i.scroll_to_content?a.scope.location.hash:a.scope.location.hash.replace("fndtn-",""),""!=s){var r=e(s);if(r.hasClass("content")&&r.parent().hasClass("tab-content"))a.toggle_active_tab(t("["+a.attr_name()+"] > * > a[href="+s+"]").parent());else{var o=r.closest(".content").attr("id");o!=n&&a.toggle_active_tab(t("["+a.attr_name()+"] > * > a[href=#"+o+"]").parent(),s)}}else for(var c in a.default_tab_hashes)a.toggle_active_tab(t("["+a.attr_name()+"] > * > a[href="+a.default_tab_hashes[c]+"]").parent())}})},toggle_active_tab:function(i,s){var r=this.S,o=i.closest("["+this.attr_name()+"]"),c=i.find("a"),l=i.children("a").first(),h="#"+l.attr("href").split("#")[1],d=r(h),_=i.siblings(),f=o.data(this.attr_name(!0)+"-init"),u=function(a){var n,i=t(this),s=t(this).parents("li").prev().children('[role="tab"]'),r=t(this).parents("li").next().children('[role="tab"]');switch(a.keyCode){case 37:n=s;break;case 39:n=r;break;default:n=!1}n.length&&(i.attr({tabindex:"-1","aria-selected":null}),n.attr({tabindex:"0","aria-selected":!0}).focus()),t('[role="tabpanel"]').attr("aria-hidden","true"),t("#"+t(e.activeElement).attr("href").substring(1)).attr("aria-hidden",null)};r(this).data(this.data_attr("tab-content"))&&(h="#"+r(this).data(this.data_attr("tab-content")).split("#")[1],d=r(h)),f.deep_linking&&(f.scroll_to_content?(a.location.hash=s||h,s==n||s==h?i.parent()[0].scrollIntoView():r(h)[0].scrollIntoView()):a.location.hash=s!=n?"fndtn-"+s.replace("#",""):"fndtn-"+h.replace("#","")),i.addClass(f.active_class).triggerHandler("opened"),c.attr({"aria-selected":"true",tabindex:0}),_.removeClass(f.active_class),_.find("a").attr({"aria-selected":"false",tabindex:-1}),d.siblings().removeClass(f.active_class).attr({"aria-hidden":"true",tabindex:-1}).end().addClass(f.active_class).attr("aria-hidden","false").find(":first-child").attr("tabindex",0),f.callback(i),d.children().attr("tab-index",0),d.triggerHandler("toggled",[i]),o.triggerHandler("toggled",[d]),c.on("keydown",u)},data_attr:function(t){return this.namespace.length>0?this.namespace+"-"+t:t},off:function(){},reflow:function(){}}}(jQuery,window,window.document);
