...
!function(t,e){"use strict";Foundation.libs.dropdown={name:"dropdown",version:"{{VERSION}}",settings:{active_class:"open",disabled_class:"disabled",mega_class:"mega",align:"bottom",is_hover:!1,opened:function(){},closed:function(){}},init:function(t,e,a){Foundation.inherit(this,"throttle"),this.bindings(e,a)},events:function(){var a=this,s=a.S;s(this.scope).off(".dropdown").on("click.fndtn.dropdown","["+this.attr_name()+"]",function(e){var i=s(this).data(a.attr_name(!0)+"-init")||a.settings;(!i.is_hover||Modernizr.touch)&&(e.preventDefault(),a.toggle(t(this)))}).on("mouseenter.fndtn.dropdown","["+this.attr_name()+"], ["+this.attr_name()+"-content]",function(t){var e,i,n=s(this);clearTimeout(a.timeout),n.data(a.data_attr())?(e=s("#"+n.data(a.data_attr())),i=n):(e=n,i=s("["+a.attr_name()+"='"+e.attr("id")+"']"));var o=i.data(a.attr_name(!0)+"-init")||a.settings;s(t.currentTarget).data(a.data_attr())&&o.is_hover&&a.closeall.call(a),o.is_hover&&a.open.apply(a,[e,i])}).on("mouseleave.fndtn.dropdown","["+this.attr_name()+"], ["+this.attr_name()+"-content]",function(){var t=s(this);a.timeout=setTimeout(function(){if(t.data(a.data_attr())){var e=t.data(a.data_attr(!0)+"-init")||a.settings;e.is_hover&&a.close.call(a,s("#"+t.data(a.data_attr())))}else{var i=s("["+a.attr_name()+'="'+s(this).attr("id")+'"]'),e=i.data(a.attr_name(!0)+"-init")||a.settings;e.is_hover&&a.close.call(a,t)}}.bind(this),150)}).on("click.fndtn.dropdown",function(e){var i=s(e.target).closest("["+a.attr_name()+"-content]");if(!(s(e.target).closest("["+a.attr_name()+"]").length>0))return!s(e.target).data("revealId")&&i.length>0&&(s(e.target).is("["+a.attr_name()+"-content]")||t.contains(i.first()[0],e.target))?(e.stopPropagation(),void 0):(a.close.call(a,s("["+a.attr_name()+"-content]")),void 0)}).on("opened.fndtn.dropdown","["+a.attr_name()+"-content]",function(){a.settings.opened.call(this)}).on("closed.fndtn.dropdown","["+a.attr_name()+"-content]",function(){a.settings.closed.call(this)}),s(e).off(".dropdown").on("resize.fndtn.dropdown",a.throttle(function(){a.resize.call(a)},50)),this.resize()},close:function(e){var a=this;e.each(function(){var s=t("["+a.attr_name()+"="+e[0].id+"]")||t("aria-controls="+e[0].id+"]");s.attr("aria-expanded","false"),a.S(this).hasClass(a.settings.active_class)&&(a.S(this).css(Foundation.rtl?"right":"left","-99999px").attr("aria-hidden","true").removeClass(a.settings.active_class).prev("["+a.attr_name()+"]").removeClass(a.settings.active_class).removeData("target"),a.S(this).trigger("closed").trigger("closed.fndtn.dropdown",[e]))}),e.removeClass("f-open-"+this.attr_name(!0))},closeall:function(){var e=this;t.each(e.S(".f-open-"+this.attr_name(!0)),function(){e.close.call(e,e.S(this))})},open:function(t,e){this.css(t.addClass(this.settings.active_class),e),t.prev("["+this.attr_name()+"]").addClass(this.settings.active_class),t.data("target",e.get(0)).trigger("opened").trigger("opened.fndtn.dropdown",[t,e]),t.attr("aria-hidden","false"),e.attr("aria-expanded","true"),t.focus(),t.addClass("f-open-"+this.attr_name(!0))},data_attr:function(){return this.namespace.length>0?this.namespace+"-"+this.name:this.name},toggle:function(t){if(!t.hasClass(this.settings.disabled_class)){var e=this.S("#"+t.data(this.data_attr()));0!==e.length&&(this.close.call(this,this.S("["+this.attr_name()+"-content]").not(e)),e.hasClass(this.settings.active_class)?(this.close.call(this,e),e.data("target")!==t.get(0)&&this.open.call(this,e,t)):this.open.call(this,e,t))}},resize:function(){var t=this.S("["+this.attr_name()+"-content].open"),e=this.S("["+this.attr_name()+"='"+t.attr("id")+"']");t.length&&e.length&&this.css(t,e)},css:function(t,e){var a=Math.max((e.width()-t.width())/2,8),s=e.data(this.attr_name(!0)+"-init")||this.settings;if(this.clear_idx(),this.small()){var i=this.dirs.bottom.call(t,e,s);t.attr("style","").removeClass("drop-left drop-right drop-top").css({position:"absolute",width:"95%","max-width":"none",top:i.top}),t.css(Foundation.rtl?"right":"left",a)}else this.style(t,e,s);return t},style:function(e,a,s){var i=t.extend({position:"absolute"},this.dirs[s.align].call(e,a,s));e.attr("style","").css(i)},dirs:{_base:function(t){var e=this.offsetParent(),a=e.offset(),s=t.offset();return s.top-=a.top,s.left-=a.left,s},top:function(t,e){var a=Foundation.libs.dropdown,s=a.dirs._base.call(this,t);return this.addClass("drop-top"),(t.outerWidth()<this.outerWidth()||a.small()||this.hasClass(e.mega_menu))&&a.adjust_pip(this,t,e,s),Foundation.rtl?{left:s.left-this.outerWidth()+t.outerWidth(),top:s.top-this.outerHeight()}:{left:s.left,top:s.top-this.outerHeight()}},bottom:function(t,e){var a=Foundation.libs.dropdown,s=a.dirs._base.call(this,t);return(t.outerWidth()<this.outerWidth()||a.small()||this.hasClass(e.mega_menu))&&a.adjust_pip(this,t,e,s),a.rtl?{left:s.left-this.outerWidth()+t.outerWidth(),top:s.top+t.outerHeight()}:{left:s.left,top:s.top+t.outerHeight()}},left:function(t){var e=Foundation.libs.dropdown.dirs._base.call(this,t);return this.addClass("drop-left"),{left:e.left-this.outerWidth(),top:e.top}},right:function(t){var e=Foundation.libs.dropdown.dirs._base.call(this,t);return this.addClass("drop-right"),{left:e.left+t.outerWidth(),top:e.top}}},adjust_pip:function(t,e,a,s){var i=Foundation.stylesheet,n=8;t.hasClass(a.mega_class)?n=s.left+e.outerWidth()/2-8:this.small()&&(n+=s.left-8),this.rule_idx=i.cssRules.length;var o=".f-dropdown.open:before",r=".f-dropdown.open:after",d="left: "+n+"px;",l="left: "+(n-1)+"px;";i.insertRule?(i.insertRule([o,"{",d,"}"].join(" "),this.rule_idx),i.insertRule([r,"{",l,"}"].join(" "),this.rule_idx+1)):(i.addRule(o,d,this.rule_idx),i.addRule(r,l,this.rule_idx+1))},clear_idx:function(){var t=Foundation.stylesheet;"undefined"!=typeof this.rule_idx&&(t.deleteRule(this.rule_idx),t.deleteRule(this.rule_idx),delete this.rule_idx)},small:function(){return matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches},off:function(){this.S(this.scope).off(".fndtn.dropdown"),this.S("html, body").off(".fndtn.dropdown"),this.S(e).off(".fndtn.dropdown"),this.S("[data-dropdown-content]").off(".fndtn.dropdown")},reflow:function(){}}}(jQuery,window,window.document);
