...
!function(e,t){"use strict";Foundation.libs.equalizer={name:"equalizer",version:"5.2.2",settings:{use_tallest:!0,before_height_change:e.noop,after_height_change:e.noop,equalize_on_small:!1},init:function(e,t,i){Foundation.inherit(this,"image_loaded"),this.bindings(t,i),this.reflow()},events:function(){this.S(t).off(".equalizer").on("resize.fndtn.equalizer",function(){this.reflow()}.bind(this))},equalize:function(t){var i=!1,n=t.find("["+this.attr_name()+"-watch]:visible"),a=n.first().offset().top,h=t.data(this.attr_name(!0)+"-init");if(0!==n.length&&(h.before_height_change(),t.trigger("before-height-change"),n.height("inherit"),n.each(function(){var t=e(this);t.offset().top!==a&&(i=!0)}),h.equalize_on_small!==!1||!i)){var s=n.map(function(){return e(this).outerHeight(!1)}).get();if(h.use_tallest){var o=Math.max.apply(null,s);n.css("height",o)}else{var r=Math.min.apply(null,s);n.css("height",r)}h.after_height_change(),t.trigger("after-height-change")}},reflow:function(){var t=this;this.S("["+this.attr_name()+"]",this.scope).each(function(){var i=e(this);t.image_loaded(t.S("img",this),function(){t.equalize(i)})})}}}(jQuery,window,window.document);
...
!function(a){"use strict";a.fn.foundation2day=function(){var t=this,i={version:"0.1",defaults:{validateDataAttribs:!0,initFoundation5:{}},dataAttribs:{"data-abide":!1,"data-abide-validator":!0,"data-accordion":!1,"data-alert":!1,"data-button":!0,"data-caption":!0,"data-class":!0,"data-clearing":!1,"data-dropdown":!0,"data-dropdown-content":!0,"data-equalizer":!1,"data-equalizer-watch":!1,"data-equalto":!0,"data-id":!0,"data-interchange":!0,"data-joyride":!1,"data-magellan-arrival":!0,"data-magellan-destination":!0,"data-magellan-expedition":!0,"data-offcanvas":!1,"data-oneof":!1,"data-options":!0,"data-orbit":!1,"data-orbit-link":!0,"data-orbit-slide":!0,"data-orbit-slide-number":!0,"data-reveal":!1,"data-reveal-ajax":!0,"data-reveal-id":!0,"data-slider":!1,"data-tab":!1,"data-text":!0,"data-tooltip":!1,"data-topbar":!1},init:function(d){var e,n=a.extend({},i.defaults,d||{}),r=[],o=[],l="",s="Syntaxfehler: ";return t.each(function(){e=a(this),r=(e.attr("title")||"").split("|"),e.removeAttr("title"),a.each(r,function(){if(o=a.trim(this).split("="),l=o[0].toLowerCase(),i.validateDataAttribs){if("undefined"==typeof i.dataAttribs[l])return alert(s+l+'" ist kein bekanntes data-Attribut in Foundation5!'),void 0;if(i.dataAttribs[l]&&o.length<2)return alert(s+l+'" benötigt einen Parameter der Form '+l+"=param !"),void 0}e.attr(l,o.length>1?o[1]:"")})}),a(document).foundation(n.initFoundation5),t}};return{init:i.init}}}(jQuery);